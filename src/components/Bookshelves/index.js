      ...
      <HeaderContext.Consumer>
        {value => {
          ...
          const darkThemeHeading = isDarkTheme
            ? 'bookshelves-dark-heading-text'
            : ''
          const headerDarkTheme = isDarkTheme
            ? 'book-shelf-dark-header'
            : 'book-shelf-header-container'
          return (
            <div className={headerDarkTheme}>
    ...
    return (
      <HeaderContext.Consumer>
        {value => {
          ...
          const darkThemeBooks = isDarkTheme
            ? 'all-books-dark-container'
            : 'all-books-container'

          return showNoBooksView ? (
            this.renderNoBooksView()
          ) : (
            <>
              <div className={darkThemeBooks}>
